...
<<<<<<< HEAD
    return
=======
    // в завдані ще потрібно вивести суму чисел
    return a + b;
    //??????DONE
>>>>>>> 879a5bf10fd7626aa67ef9fbd9ab764112b48489
}
...
<<<<<<< HEAD
=======
// є різні види розподілу випадкових величин (нормальний розподіл, рівномірний). 
//Треба дивитись що пропонують в рішені задачі
>>>>>>> 879a5bf10fd7626aa67ef9fbd9ab764112b48489
    ?
    ?
    ? ? ? ? ? ? ? ? ? ? ? ? ? ? ? ? ? ? ? ? ? ? ? ? ? ? ? ? ? ? ? ? ? ? ? ? ? ? ? ? ? ? ? ? ?
